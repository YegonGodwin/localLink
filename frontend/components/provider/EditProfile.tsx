...
export const EditProfile: React.FC<EditProfileProps> = ({ onPreview }) => {
  ...
  // Mock initial state from user context (would normally come from props/context)
  const [formData, setFormData] = useState({
    name: "John's Plumbing",
    tagline: "Expert Residential & Commercial Solutions",
    bio: "With over 15 years of experience serving the local area, we specialize in high-quality plumbing installations, leak repairs, and emergency services. Our mission is to provide reliable, efficient, and transparent services to every neighbor.",
    email: "john@plumbing.com",
    phone: "(555) 012-3456",
    address: "Seattle, WA",
    website: "https://johnsplumbing.com",
    avatar: "https://randomuser.me/api/portraits/men/32.jpg",
    coverImage: "https://images.unsplash.com/photo-1581578731117-104f2a8d275d?auto=format&fit=crop&q=80&w=1200"
  });
  ...
  const handlePreview = () => {
    ...
    const previewService: Service = {
      ...
      category: 'Plumbing', // Default category for preview
        ...
        <div className="absolute -bottom-16 left-8 flex items-end gap-6">
          ...
          <div className="mb-4 hidden md:block">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-slate-400 text-sm">Member since Oct 2023</span>
            </div>
          </div>
        </div>
      </div>
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <select className="w-full bg-slate-950 border border-slate-800 rounded-lg px-4 py-3 text-white focus:border-blue-500 outline-none">

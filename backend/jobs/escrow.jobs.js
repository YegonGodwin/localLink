...
import { processEscrowReleaseQueueBatch } from "../controllers/payment.controller.js";
...
export const startEscrowJobs = () => {
    ...
    console.log(
        `[escrow-jobs] started autoReleaseInterval=${autoReleaseIntervalMs}ms releaseQueueInterval=${releaseQueueIntervalMs}ms`
    );
